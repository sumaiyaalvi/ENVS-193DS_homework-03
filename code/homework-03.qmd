...
An affective visualization of my personal screen time data could focus on showing how different days felt rather than just showing numerical patterns. For example, I could use color gradients to represent mood or energy levels based on sleep time the night before, with softer colors for well-rested days and darker/more intense colors for more tired days. This would make the data feel more personal and reflective rather than purely statistical.

## b. Create a sketch (on paper) of your idea.

![Affective visualization sketch](affective.png)
